                ...
                for (JsonElement objEl : layer.getAsJsonArray("objects")) {
                    ...
                    switch (typeName) {
                        case "pierresgeneralstore" -> {
                            ...
                            int dY = ((PierresGeneralStore) go).getDoorPosition().getY()+3;
                        ...
                        case "thestardropsaloon" -> {
                            ...
                            int dY = ((TheSaloonStardrop) go).getDoorPosition().getY()+3;
                        ...
                        case "blacksmith" -> {
                            ...
                            int dY = ((Blacksmith) go).getDoorPosition().getY()+3;
                        ...
                        case "jojamart" -> {
                            ...
                            int dY = ((JojaMart) go).getDoorPosition().getY()+3;
                        }
                        ...
                        case "carpentersshop" -> {
                            ...
                            int dY = ((CarpentersShop) go).getDoorPosition().getY()+3;
