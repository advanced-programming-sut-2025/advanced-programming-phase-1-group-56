...
public class ShopStateWindow extends Window {
    private static ShopState shopState = ShopState.WAIT;
    ...
    public static ShopState getShopState() {
        return shopState;
    }

    public static void setShopState(ShopState shopState) {
        ShopStateWindow.shopState = shopState;
    }
