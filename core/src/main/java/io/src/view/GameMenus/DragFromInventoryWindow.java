...
public class DragFromInventoryWindow extends Group implements InputProcessor, InterruptingWindow {
    private Group group;
    ...
    private Position boxPosition = new Position(950, 270);
    private CostumeRunnable boxDropRunnable = (x) -> {
    };
    private Position boxDropDimentions = new Position(50, 80);

    public DragFromInventoryWindow(Image boxImage) {
        group = new Group();
    ...
    public void createTrash() {
        Image trashCan = boxImage;
        trashCan.setOrigin(Align.center);
        trashCan.setScale(1.2f);
        trashCan.setPosition(boxPosition.getX() - (this.getWidth() / 2), boxPosition.getY());
        trashCan.setSize(boxDropDimentions.getX(), boxDropDimentions.getY());
    ...
    public void showDialog() {
        ...
        StardewValley.getGameView().getStage().addActor(this);
    ...
    public CostumeRunnable getBoxDropRunnable() {
        return boxDropRunnable;
    }

    public void setBoxDropRunnable(CostumeRunnable boxDropRunnable) {
        this.boxDropRunnable = boxDropRunnable;
    }
    ...
    public Position getBoxDropDimentions() {
        return boxDropDimentions;
    }

    public void setBoxDropDimentions(Position boxDropDimentions) {
        this.boxDropDimentions = boxDropDimentions;
    }
