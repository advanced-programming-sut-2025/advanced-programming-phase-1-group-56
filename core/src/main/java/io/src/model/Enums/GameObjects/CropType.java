...
public enum CropType implements initialPlant {
    ...
    COFFEE_BEAN(FoodType.COFFEE_BEAN, new int[]{1, 2, 2, 3, 2}, 10, false, 2, 15, false, -1, -1, new Seasons[]{Seasons.Spring, Seasons.Summer}, false, "Coffee_Stage_1"),
    ...
    CropType(FoodType cropItem, int[] stages, int totalHarvestTime, boolean oneTime, int regrowthTime,
             int baseSellPrice, boolean isEdible, int energy, int health, Seasons[] season, boolean canBecomeGiant, String assetName) {
