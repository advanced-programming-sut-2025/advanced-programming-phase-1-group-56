...
public enum FoodType implements ItemType {
    ...
    HASH_BROWNS("Hash Browns", 90, 120, BuffType.FarmingBuff, "Hashbrowns"),
    ...
    FARMERS_LUNCH("Farmer's Lunch", 200, 150, BuffType.FarmingBuff, "Farmer_Lunch"),
    SURVIVAL_BURGER("Survival Burger", 125, 180, BuffType.ForagingBuff5, ""),
    DISH_OF_THE_SEA("Dish O' The Sea", 150, 220, BuffType.FishingBuff5, "Dish_Of_The_Sea"),
    SEAFORM_PUDDING("Seaform Pudding", 175, 300, BuffType.FishingBuff10, "Seafoam_Pudding"),
    MINERS_TREAT("Miner's Treat", 125, 200, BuffType.MiningBuff, "Miner_Treat"),
    //crop
    ...
    BLUEBERRY("Blueberry", 25, 50, null, "Blueberry"),
    ...
    CRANBERRIES("Cranberries", 38, 75, null, "Cranberry"),
    ...
    POWDER_MELON("Powder Melon", 63, 60, null, "Powdermelon"),
    ...
    JOJA_COLA("Joja Cola", 13, 25, null, "Joja_Cola_large"),
    ...
    FoodType(String name, int energy, int price, BuffType buffType, String assetName) {
        this.name = name;
        this.energy = energy;
        this.price = price;
