...
public enum FoodRecipesList implements Saleable {
    ...
    RED_PLATE("Red Plate", FoodType.RED_PLATE, new Slot[]{new Slot(new Food(FoodType.RED_CABBAGE), 1), new Slot(new Food(FoodType.RADISH), 1)}, 240, BuffType.MaxEnergy50, "Stardrop Saloon", 400, ""),
    ...
    FARMERS_LUNCH("Farmers Lunch", FoodType.FARMERS_LUNCH, new Slot[]{new Slot(new Food(FoodType.OMELETTE), 1), new Slot(new Food(FoodType.PARSNIP), 1)}, 200, BuffType.FarmingBuff, "Farming Level 1", 150, "Farmer_Lunch"),
    SURVIVAL_BURGER("Survival Burger", FoodType.SURVIVAL_BURGER, new Slot[]{new Slot(new Food(FoodType.BREAD), 1), new Slot(new Food(FoodType.CARROT), 1), new Slot(new Food(FoodType.EGGPLANT), 1)}, 125, BuffType.FarmingBuff, "Foraging Level 3", 180, ""),
    DISH_O_THE_SEA("Dish O The Sea", FoodType.DISH_OF_THE_SEA, new Slot[]{new Slot(new Fish(FishType.Sardine), 2), new Slot(new Food(FoodType.HASH_BROWNS), 1)}, 150, BuffType.FishingBuff5, "Fishing Level 2", 220, "Seafoam_Pudding"),
    SEAFOAM_PUDDING("Seafoam Pudding", FoodType.SEAFORM_PUDDING, new Slot[]{new Slot(new Fish(FishType.Flounder), 1), new Slot(new Fish(FishType.MidnightCarp), 1)}, 175, BuffType.FishingBuff10, "Fishing Level 3", 300, ""),
    MINERS_TREAT("Miners Treat", FoodType.MINERS_TREAT, new Slot[]{new Slot(new Food(FoodType.CARROT), 2), new Slot(new Food(FoodType.SUGAR), 1), new Slot(new Etc(EtcType.MILK), 1)}, 125, BuffType.MiningBuff, "Mining Level 1", 200, "Miner_Treat");
    ...
    public final BuffType effect;
    public final String source;
    public final int sellPrice;
    private final String assetName;

    FoodRecipesList(String name, FoodType foodType, Slot[] ingredients, int energy, BuffType effect, String source, int sellPrice, String assetName) {
        this.name = name;
