...
public enum ArtisanGoodType implements ItemType {
    HONEY("Honey", "It's a sweet syrup produced by bees.", 75, 96, null, 350, "Honey"),
    CHEESE("Cheese", "It's your basic cheese.", 100, 3, new Slot[]{new Slot(new Etc(EtcType.MILK), 1)}, 230, "Cheese"),
    BIG_CHEESE("Cheese", "It's your basic cheese.", 100, 3, new Slot[]{new Slot(new Etc(EtcType.BIG_MILK), 1)}, 345, "Cheese"),
    GOAT_CHEESE("GoatCheese", "Soft cheese made from goat's milk.", 100, 3, new Slot[]{new Slot(new Etc(EtcType.GOAT_MILK), 1)}, 345, "Goat_Cheese"),
    BIG_GOAT_CHEESE("GoatCheese", "Soft cheese made from goat's milk.", 100, 3, new Slot[]{new Slot(new Etc(EtcType.BIG_GOAT_MILK), 1)}, 600, "Goat_Cheese"),
    BEER("Beer", "Drink in moderation.", 50, 24, new Slot[]{new Slot(new Food(FoodType.WHEAT), 1)}, 200, "Beer"),
    ...
    PALE_ALE("PaleAle", "Drink in moderation.", 50, 72, new Slot[]{new Slot(new Food(FoodType.HOPS), 1)}, 300, "Pale_Ale"),
    ...
    DRIED_FRUIT("DriedFruit", "Chewy pieces of dried fruit.", 75, -1, new Slot[]{new Slot(new Fruit(FruitType.ANY_FRUIT), 5)}, -1, "Dried_Fruit"),
    ...
    DUCK_MAYONNAISE("Duck Mayonnaise", "It's a rich, yellow mayonnaise.", 75, 3, new Slot[]{new Slot(new Etc(EtcType.DUCK_EGG), 1)}, 37, "Duck_Mayonnaise"),
    DINOSAUR_MAYONNAISE("Dinosaur Mayonnaise", "Thick and creamy, vivid green, smells like grass and leather.", 125, 3, new Slot[]{new Slot(new Etc(EtcType.DINOSAUR_EGG), 1)}, 800, "Dinosaur_Mayonnaise"),
    TRUFFLE_OIL("Truffle Oil", "A gourmet cooking ingredient.", 38, 6, new Slot[]{new Slot(new Etc(EtcType.TRUFFLE), 1)}, 1065, "Truffle_Oil"),
