...
public enum EtcType implements ItemType {
    ...
    SPEED_GRO("Speed_Gro", 20 , null),
    DELUXE_SPEED_GRO("Deluxe_Speed_Gro", 40 , null),
    EGG("Egg", 50 , null),
    BIG_EGG("Big_Egg", 50 , null),
    DUCK_EGG("Duck_Egg", 95 , null),
    DUCK_FEATHER("Duck_Feather", 250 , null),
    WOOL("Wool", 340 , null),
    RABBITS_FOOT("Rabbit's_Foot", 565 , null),
    DINOSAUR_EGG("Dinosaur_Egg", 350 , null),
    MILK("Milk", 125 , null),
    BIG_MILK("Big_Milk", 190 , null),
    GOAT_MILK("Goat_Milk", 225 , null),
    BIG_GOAT_MILK("Big_Goat_Milk", 345 , null),
