...
public class ProfileMenuController extends CommandController {
    public static Result manageChangePassword(String newPassword, String oldPassword) {
        ...
        String hashedInputPassword = MakePasswordSHA_256.hashPassword(oldPassword, App.getCurrentUser().getSalt());
        System.out.println("hashed old password :" + hashedInputPassword);
        System.out.println("User Password : " + App.getCurrentUser().getPassword());
        ...
        App.getCurrentUser().setPassword(hashPassword);
